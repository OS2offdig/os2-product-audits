...
flowchart TD
    ...
    A[Offentliggjort materiale<br/>om OS2-produktet] --> B[Sekretariatet<br/>gennemfører evaluering]
    B --> C[Resultat præsenteres<br/>for OS2's bestyrelse]
    C --> D[Bestyrelsen forholder sig<br/>til evt. tiltag og prioriteringer]
    D --> E[Resultat præsenteres<br/>for det enkelte produkt]
    E --> F[Samarbejde om at strukturere<br/>governancerapport og årshjul]
    F --> G{Mindst én gang årligt?}
    G -->|Ja – ny vurdering| B
```
