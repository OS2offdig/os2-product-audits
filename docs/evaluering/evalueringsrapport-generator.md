...
function mapStatus(v) {
  ...
  if (v === "Ved ikke") return { emoji: "🔴", key: "red" };
  if (v === "Planlagt") return { emoji: "🟡", key: "yellow" };
